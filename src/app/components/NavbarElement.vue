...
function click(event: MouseEvent) {
    ...
    const navbar_list_button_element = (document.querySelector(".navbar-list-button-dehaze") as HTMLElement);
    const navbar_list_button_img_element = (document.querySelector(".navbar-list-button-dehaze > img") as HTMLElement);
