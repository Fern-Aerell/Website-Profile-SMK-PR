...
function scroll() {
    ...
    (document.querySelector('.model-shadow') as HTMLElement).style.bottom = (-2 - (scrollY || 0) / 60) + 'rem';
};
...
<template>
    <div class="header-container">
        ...
        <div class="model-container animate__animated animate__slideInRight">
            <img class="model-shadow model-size" :src="model_shadow_image_webp" alt="model image shadow">
