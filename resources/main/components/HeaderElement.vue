...
import type SocialMediaModel from '@/main/ts/models/SocialMediaModel';
import { onMounted, onUnmounted, ref } from 'vue';

import model_image_webp from '@/main/images/anime_models/model_woman_01.webp';
import model_shadow_image_webp from '@/main/images/anime_models/model_woman_01_shadow.webp';
import header_bg_image_webp from '@/main/images/backgrounds/header-bg.webp';
import pencil_image_webp from '@/main/images/cursors/pencil.webp';
